namespace CinemaApp.Web.Infrastructure.Extensions
{
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        {
            // TODO: Rewrite the implementation in such way, that the user must create a 
            //       single class for every repository
            ...
            foreach (Type type in modelTypes)
            {
                if (!typesToExclude.Contains(type))
                {
                    ...
                    {
                        constructArgs[1] = idPropInfo.PropertyType;  //  PropertyType / GetType()
                    }
